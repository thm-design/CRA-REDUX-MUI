                        ...
                        >
                            <TableRow>
                                <TableHeaderColumn colSpan="3" tooltip="Super Header" style={{textAlign: 'left'}}>
                                    Add Supplier | Undo | Redo
                                </TableHeaderColumn>
                            </TableRow>
                            <TableRow>
                                <TableHeaderColumn className="headerTH" tooltip="The SUPPLIER NAME">
                                    SUPPLIER NAME
                                </TableHeaderColumn>
                                <TableHeaderColumn className="headerTH" tooltip="The STATUS">STATUS</TableHeaderColumn>
